...
Overriding the built-in idezapis
---------------------------------

While creating custom themes, especially when overriding idezapis, it may be useful to use the built-in idezapis as
a reference. These can be found within the theme directory of `../lib/lib/main/org.keycloak.keycloak-themes-25.0.2.jar`, which can be opened using any
